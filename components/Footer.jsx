...
const Footer = () => {
  return (
    <>
            <div data-scroll data-scroll-section data-scroll-speed='-.03' className='w-full text-white h-screen bg-zinc-700 flex justify-between  p-20'>
                    <div className='w-1/2 h-full flex flex-col justify-between font-["Neue_Montreal"]'>
                            <div>
                            <h1 className='text-6xl leading-none tracking-tight mb-[-6] uppercase font-semibold'>Eye_</h1>
                            <h1 className='text-6xl leading-none tracking-tight mb-[-6] uppercase font-semibold'>Opening</h1>
                            </div>
                    ...
                    <div className='w-1/2 h-full flex justify-between flex-col '>
                            <h1 className='text-6xl leading-none tracking-tight font-semibold font-["Neue_Montreal"]'>PRESENTATIONS</h1>
                            <div>
                                        <h3 className='text-white mb-6'>L:</h3>
                            ...
                            <div>
                                        <h3 className='text-white mb-6'>A:</h3>

                                        <div className='text-zinc-200 '>
                                                <h4>Pakistan, Rahim Yar Khan</h4>
                                                <h4>+92 3083611140</h4>
                                        </div>
                            </div>
                    </div>
